...
import { addUsers, updateUsers } from "../slices/UserSlices";
...
function EmployeeDetails() {
    ...
    const existingUsers = selector.find(item => item.id === id);
    ...
    const handleSubmit = (e) => {
        ...
        if(id)
        {
            dispatch(updateUsers(employee));
        }
        else
        {
            dispatch(addUsers({...employee,id:uuid()}))
        }
